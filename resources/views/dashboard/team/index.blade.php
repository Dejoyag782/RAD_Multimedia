...
@import ajax;
    <x-slot name="header">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-12 text-center">
                                            ...
                                            <h5 class="text-start text-muted section-subheading" style="font-size: 15pt; display:flex; justify-content:space-between;">Manage | Team </h5>
                                        </div>
                                    </div>
        ...
        @include('dashboard.team.ajax')
        @include('dashboard.team.modals')
